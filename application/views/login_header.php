		...
		<!-- <header> -->
	      ...
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo base_url().'Main_controller/main_user' ?>">Geek's Shop</a>
	        </div>
	        <div id="navbar" class="collapse navbar-collapse">
	          ...
	          <ul class="nav navbar-nav navbar-right">
	            <!-- <li class="active"><a href="<?php echo base_url().'index.php' ?>">Home</a></li> -->
							...
							<li><?php echo anchor('Login_controller/call_edit_user/'.$this->session->userdata("name"),$this->session->userdata("name")); ?></li>
